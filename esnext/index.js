...
var VList = /** @class */ (function (_super) {
    ...
    function VList() {
        ...
        _this.updateRects = function () {
            ...
            for (var index = startIndex; index < length; index++) {
                _this.rects.push(new Rectangle({ top: top, index: index, defaultHeight: defaultHeight }));
                top += defaultHeight;
            }
        };
        _this.updateItemSize = function (args) {
            ...
            var scrollTop = isWindow(scrollable) ? window.pageXOffset : scrollable.scrollTop;
        ...
        _this.handleScroll = function () {
            ...
            var scrollTop = (isWindow(scrollable) ? getDocument() : scrollable).scrollTop;
    ...
    VList.prototype.getVisibleCount = function () {
        ...
        var height = isWindow(scrollable) ? window.innerHeight : scrollable.offsetHeight;
    ...
    VList.prototype.getVisibleItems = function () {
        ...
        for (var index = this.startIndex; index < this.endIndex; index++) {
            items.push(React.createElement(Item, { key: index, index: index, onResize: this.updateItemSize, cachedHeights: this.cachedHeights, height: this.getRenderedItemHeight(index) }, this.renderItem));
        }
        return items;
    };
    ...
    VList.prototype.render = function () {
        ...
        if (hasMore && !data.length) {
            return (React.createElement("div", { style: style, ref: this.node, className: className }, onLoading && onLoading()));
        }
        return (React.createElement("div", { style: style, ref: this.node, className: className }, visibleItems.length ? (React.createElement("div", { style: { paddingTop: paddingTop, paddingBottom: paddingBottom } },
            visibleItems,
            this.renderLoading(),
            ";")) : (placeholder)));
    };
